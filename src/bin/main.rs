...
fn main() -> ! {
    ...
    let mut matrix_display = WaveShare64X32Display::new(peripherals, tx_descriptors);
...
impl<'a> WaveShare64X32Display<'a> {
    pub fn new(peripherals: Peripherals, tx_descriptors: &'static mut [DmaDescriptor]) -> Self {
